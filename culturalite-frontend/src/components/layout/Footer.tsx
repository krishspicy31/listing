 ...
 * Professional footer with cultural design elements
 */
          ...
          <div className="lg:col-span-1">
            ...
            >
              ...
              <p className="mt-4 text-sm text-gray-600 leading-relaxed">
                Connecting you with the vibrant cultural experiences happening in your city. 
                Discover music, dance, festivals, and art that celebrate our rich heritage.
              </p>
            </motion.div>
          </div>
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <p className="text-sm text-gray-500">
              © 2025 CulturaLite. All rights reserved. Celebrating culture, connecting communities.
            </p>
